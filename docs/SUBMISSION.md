...
| Distress voice detection | `src/lib/voice/*` (experimental) | ✅ 252 passed mobile unit tests (precision/recall 93.3%) |
...
**Unit tests:** 252 (`cd novadrive-mobile && npm test` — 100% pass rate)
